...
class TantanganController extends Controller
{
    public function buat(Request $request)
    {
        ...
        TantanganUser::create([
            ...
            'target_tantangan' => $request->target_harian,
            'penghargaan' => $request->reward,
            'tanggal_mulai' => now(),
            'tanggal_selesai' => now()->addDays($request->durasi_hari),
        ]);
    ...
    public function progres()
    {
        ...
        $tantangan = TantanganUser::where('creator_user_id', $userId)
            ->latest()
            ->first();
        ...
        $selesai = $kaloriHariIni >= $tantangan->target_tantangan;
